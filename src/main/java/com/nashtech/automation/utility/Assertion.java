...
public class Assertion {
	...
	public static void assertNotEquals(String actualValue, String expectedValue, String errorMess, String successMess)
			throws Exception {
		try {
			Assert.assertNotEquals(actualValue, expectedValue, errorMess);
			HtmlReporter.pass(successMess + " - [" + actualValue + "]");
		} catch (AssertionError e) {
			HtmlReporter.fail(errorMess + " - expected not match [" + expectedValue + "] but found [" + actualValue + "]", e, "");
			throw e;
		}
	}
